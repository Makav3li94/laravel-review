...
interface ReviewRateable
{
     ...
     * @return double
     */
    public function averageCommunicationRating($round = null);
     ...
     * @return double
     */
    public function averageCostRating($round = null);
     ...
     * @return double
     */
    public function averageTimeManagementRating($round = null);
     ...
     * @return double
     */
    public function averageLanguageProficiencyRating($round = null);
     ...
     * @return int
     */
    public function countCommunicationRating();

    /**
     *
     * @return int
     */
    public function countCostRating();

    /**
     *
     * @return int
     */
    public function countTimeManagementRating();
     ...
     * @return int
     */
    public function countLanguageProficiency();
